...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Denarius-seeder\n"
...
static const string mainnet_seeds[] = {"denarius.host", "hashbag.cc", "denariusexplorer.org", "denarius.trade", "denarius.tech", "denarius.network"};
static const string testnet_seeds[] = {"testnet-seed.denarius.host",
                                       "testnet-seed.hashbag.cc",
                                       "testnet-seed.denariusexplorer.org",
                                       "testnet-seed.denarius.trade",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 33339), true);
  }
  do {
